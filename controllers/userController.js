...
exports.uploadPhoto = function(req,res){
  if(req.session.user){
    ...
    user.uploadPhoto().then(function(result){
      let path = "/student-info/" + req.body.ID; 
      res.redirect(path)
    }).catch(function(e){
      console.log(e)
    })
...
exports.uploadTeacherPhoto = function(req,res){
  if(req.session.user){
    let user = new User(req)
    user.uploadTeacherPhoto().then(function(result){
      let path = "/teacher-info/" + req.body.ID; 
      res.redirect(path)
    }).catch(function(e){
      console.log(e)
    })
